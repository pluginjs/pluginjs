...
describe('MediaBuilder', () => {
  test('should build the min media correctly', () => {
  ...
  test('should build the max media correctly', () => {
  ...
  test('should build the between media correctly', () => {
  ...
  test('should get the media correctly', () => {
  ...
  test('should use px as default unit', () => {
