...
export default () => parseHTML`
    <div class="example">
        <input class="example-inline" type="radio" name="js-inline" id="js-inline-foo" value="foo" data-theme="null" />
        <label for="js-inline-foo"><i></i> Foo</label>
        <input class="example-inline" type="radio" name="js-inline" id="js-inline-bar" value="bar" data-theme="inline" checked="checked"  />
