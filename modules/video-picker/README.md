...
CommonJS
```javascript
require("@pluginjs/video-picker")
```

**CDN:**
Development:
```html
<script src="https://unpkg.com/@pluginjs/{moduleName}/dist/video-picker.js"></script>
<link rel="stylesheet" href="https://unpkg.com/@pluginjs/{moduleName}/dist/video-picker.css">
```
Production:
```html
<script src="https://unpkg.com/@pluginjs/{moduleName}/dist/video-picker.min.js"></script>
<link rel="stylesheet" href="https://unpkg.com/@pluginjs/{moduleName}/dist/video-picker.min.css">
```
...
**example:**
```javascript
Pj.$videoPicker('.element', set)
Pj.$videoPicker('.element', set, "foo")
Pj.$videoPicker('.element', set, "foo", "bar")
```
