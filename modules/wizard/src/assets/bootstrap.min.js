    ...
    (FormValidation.Framework.Bootstrap.prototype = a.extend(
      ...
      FormValidation.Base.prototype,
      {
        _fixIcon(a, b) {
          ...
          g.find('label').length === 0 && b.addClass('fv-icon-no-label'),
            g.find('.input-group').length !== 0 &&
              b
                .addClass('fv-bootstrap-icon-input-group')
                .insertAfter(g.find('.input-group').eq(0))
        },
        _createTooltip(a, b, c) {
          let d = this._namespace,
            e = a.data(`${d}.icon`)
          if (e) {
            switch (c) {
              case 'popover':
    ...
    (a.fn.bootstrapValidator = function(b) {
      ...
      return this.each(function() {
        ...
        e ||
          ...
          typeof b === 'string' && e[b](...Array.prototype.slice.call(c, 1))
      })
    }),
