...
const value = '{"fontFamily": {"source":"system","font":"Arial"}}'
const valueObj = {
  fontFamily: { font: 'Arial', source: 'system' },
  fontSize: 'inherit',
  fontStyle: 'normal',
  fontWeight: 'inherit',
  lineHeight: 'inherit',
...
describe('FontEditor', () => {
  ...
  describe('api call', () => {
    test('should not call bind', () => {
      const $element = FontEditor.of(generateHTMLSample(), { source })
  ...
  describe('initialize()', () => {
    ...
    test('should trigger ready event', () => {
      ...
      const api = FontEditor.of($element, { source })
  ...
  describe('get()', () => {
    ...
    test('should get the value with value', () => {
      ...
      expect(api.get()).toBeObject(valueObj)
    })
  })
